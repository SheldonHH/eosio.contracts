...
class bosio_issuance_tester : public tester {
public:
...
BOOST_AUTO_TEST_SUITE(bosio_issuance_tests)

BOOST_FIXTURE_TEST_CASE( create_tests, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_negative_max_supply, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( symbol_already_exists, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_max_supply, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_max_decimals, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( issue_tests, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( retire_tests, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( transfer_tests, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( open_tests, bosio_issuance_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_tests, bosio_issuance_tester ) try {
